...
#Category of MMO
category1 = Category(name = "MMO")

session.add(category1)
session.commit()

item2 = Item(name = "Dauntless", description = "Gather your friends, forge your weapons, and hunt ferocious behemoths in Dauntless, the co op multiplayer RPG from Phoenix Labs, a studio consisting of developers from some of the biggest MMORPG ever made.", category = category1)

session.add(item2)
session.commit()


item1 = Item(name = "Crossout", description = "Neverwinter is an action MMORPG based on the acclaimed Dungeons and Dragons universe. In Neverwinter you take on the role as a mighty hero who must set out to protect the lands of Neverwinter from those who conspire to see it destroyed.", category = category1)

session.add(item1)
session.commit()

item3 = Item(name = "Neverwinter", description = "Neverwinter is an action MMORPG based on the acclaimed Dungeons and Dragons universe. In Neverwinter you take on the role as a mighty hero who must set out to protect the lands of Neverwinter from those who conspire to see it destroyed.", category = category1)

session.add(item3)
session.commit()

item4 = Item(name = "Guild Wars 2", description = "Guild Wars 2 represents ArenaNets attempt to turn MMO convention on its ears and create an engaging game for players of all skill levels and play styles", category = category1)
...
category2 = Category(name = "Simulations")

session.add(category2)
session.commit()


item1 = Item(name = "The Sims", description = "basicly full life simulation", category = category2)
